...
export const BORROW_FEE: Lexicon = {
  term: "Borrowing Fee",
  description:
    "The Borrowing Fee is a one-off fee charged as a percentage of the borrowed amount (in MUSD) and is part of a Trove's debt. The fee varies between 0.5% and 5% depending on MUSD redemption volumes."
};
...
export const STABILITY_POOL_LUSD: Lexicon = {
  term: "MUSD in Stability Pool",
  description:
    "The total MUSD currently held in the Stability Pool, expressed as an amount and a fraction of the MUSD supply."
};
...
export const LUSD_SUPPLY: Lexicon = {
  term: "MUSD supply",
  description: "The total MUSD minted by the Liquity Protocol."
};
