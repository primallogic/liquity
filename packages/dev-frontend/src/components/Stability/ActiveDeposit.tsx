    ...
    <Card>
      ...
      <Box sx={{ p: [2, 3] }}>
                ...
                <InfoIcon
                  tooltip={
                    <Card variant="tooltip" sx={{ width: "240px" }}>
                      Although the MONSTA rewards accrue every minute, the value on the UI only updates
        ...
        <Flex variant="layout.actions">
          ...
          <ClaimRewards disabled={!hasGain && !hasReward}>Claim BNB and MONSTA</ClaimRewards>
        </Flex>

        {hasTrove && (
          <ClaimAndMove disabled={!hasGain}>Claim MONSTA and move BNB to Trove</ClaimAndMove>
        )}
      </Box>
